    ...
    <div class="container">
      <div class="col-12 pb-5 pt-3">
        <div class="row">
          <div class="col-12 ">
            <div  class="py-5">
              <h2 class="text-center page-title fw-700">Vehicle Tracker</h2>
          ...
          <div class="col-12 py-4" >
            <div class="col-12 no-gutter">
              ...
              <?php $i = 0; ?>
              @foreach ($vehicles_list as  $title => $value) 
                <?php $number = $i++; ?>
                
                  <div class="row">
                  <div class="col-md-6 no-gutter">
                    <img src="{{ asset('/') }}images/products/{{ $vehicle_pic[$number]->type }}/{{ $vehicle_pic[$number]->picture_id }}.jpg" class="img-fluid mx-auto d-block"alt="trackmate">
                  </div>
                  <div class="col-md-6 no-gutter pt-5">
                      <h4 class="text-d1 fw-700">{{ $title }}</h4>

                      @if($vehicle_pic[$number]->prod_price > "0.00")
                        <h3 class="prize-text fw-700 ml-4"><span>&#8369;</span> {{ $vehicle_pic[$number]->prod_price }}</h3>
                      @else 
                      ...
                      @if($vehicle_pic[$number]->install_price > "0.00")

                        <p class="text-d1 fw-400">Installation Fee:</p>
                        <ul class="">
                            <li class=" prod-desc">{{ $vehicle_pic[$number]->loc_content }} - {{ $vehicle_pic[$number]->install_price }}</li>
                            <li class=" prod-desc">
